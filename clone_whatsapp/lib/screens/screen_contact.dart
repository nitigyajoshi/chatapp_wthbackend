...
import 'package:clone_whatsapp/screens/new_group.dart';
...
return [
PopupMenuItem(child: Text('Invite friend'),value: "Invite friend",),
...
PopupMenuItem(child: Text('Help'),value: "Help"),
      ...
      body: ListView.builder(
        itemCount: person.length+2,itemBuilder: (context,index){
if(index==0){
  return
  InkWell(onTap: (){
