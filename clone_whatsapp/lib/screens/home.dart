...
import 'package:clone_whatsapp/screens/camera.dart';
...
return [
PopupMenuItem(child: Text('NewGroup'),value: "NewGroup",),
PopupMenuItem(child: Text('New bodcast'),value: "New bodcast",
),
PopupMenuItem(child: Text('WhatsApp web'),value: "'WhatsApp web"),
PopupMenuItem(child: Text('Shared message'),value: "Shared message"),
