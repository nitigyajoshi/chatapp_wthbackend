...
name:'Vicky'
,time:'4:00'
,message:'hello buddy',id: 2
     ),
     ChatModel(
name:'walke'
,time:'4:00'
,message:'hello buddy',id: 3
     ),
     ChatModel(
name:'yj244'
,time:'4:00'
,message:'hello buddy',id: 4
     ),
   ];
  @override
...
//Navigator.pushReplacement(context,MaterialPageRoute(builder:(builder)=>Home(chatmodels:chatmodels)));
         ...
         ListView.builder(itemCount: chatmodels.length,itemBuilder: (context,index){
...
Navigator.pushReplacement(context,MaterialPageRoute(builder:(builder)=>Home(
  chatmodels:chatmodels,sourcechat:sourcechat)));
          },child: Button(name:chatmodels[index].name ,icon: Icons.person,));
        }),
      //sourcechat=chatmodels.removeAt(index);
    );
  }
