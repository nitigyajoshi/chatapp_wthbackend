...
import 'package:clone_whatsapp/Widgets/button.dart';
import 'package:clone_whatsapp/Widgets/contact.dart';
import 'package:clone_whatsapp/Widgets/selected_avatar.dart';
...
IconButton(onPressed: (){}, icon: Icon(Icons.search)),
      ...
      body: Stack(
        children: [
          ListView.builder(
            itemCount: person.length,itemBuilder: (context,index){
if(index==0){
...
child: ListView.builder(
  scrollDirection: Axis.horizontal,itemCount:person.length ,
